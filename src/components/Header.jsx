...
function Header() {
    ...
    return (
        ...
        >
            <div className="h-[40px] w-[40px] lg:h-[70px] lg:w-[70px] border-r-2 lg:border-r-4 pr-[2px] md:pr-[10px] border-black">
                <img src={logo} alt="" className="object-cover w-full h-full"></img>
            </div>
