    ...
    >
      <div className="w-auto h-auto flex flex-col items-center justify-start">
        ...
        <div className="h-auto relative lg:h-[515px] w-[90%]">
          ...
          <h3
            className={`absolute text-xs lg:text-lg top-[-26px] lg:top-[-38px] h-[26px] lg:h-[38px] px-2 lg:px-4 py-2 text-center left-0 text-white rounded-tr-xl rounded-tl-xl airbnb ${picture.category === "Thông báo" ? "bg-blue-700" : "bg-cyan-700"
              }`}
          >
            {picture.category}
          </h3>
