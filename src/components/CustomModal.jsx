...
const CustomModal = ({ open, isSuccess, action, onClose, errorMes }) => {
    return (
        <div>
            ...
            >
                <div
                    className={`absolute border-b-[8px] ${isSuccess ? "border-b-green-500" : "border-b-amber-600"
                ...
                >
                    ...
                    >
                        <div className="flex flex-row gap-4 h-full w-full">
                            <div
                                className={`h-[45px] w-[45px] p-1 self-center rounded-xl flex justify-center items-center ${isSuccess ? "bg-green-500/20" : "bg-amber-600/20"
                                    } `}
                            >
                                <img
